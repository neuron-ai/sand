...
Aside from an editor (preferably VS Code), Go, Git and Python, that is all you really need for this.
...
| --------- | -------------------------------------------- | ------------------------------- |
| `add`     | Adding something new                         | `add-new-lexer-design`          |
| `improve` | Improving efficiency or design / refactoring | `improve-parser-ast-efficiency` |
...
| Language | Style File                             |
| -------- | -------------------------------------- |
| Go       | [admin/style/go.md](admin/style/go.md) |
...
## Go Message
Use for Go scripts. There is a `license` snippet that'll work in Go scripts.
